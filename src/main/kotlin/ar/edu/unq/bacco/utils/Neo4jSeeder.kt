    ...
    fun seedDatabase() {
       println("START POPULATION OF DB")
        if (recipeRepository.count() == 0L && beverageRepository.count() == 0L) {
            ...
            val pinkGinTonic = Recipe(name = "Pink Gin Tonic", description = "Elegancia y un toque de dulzura.", imagePath = "https://github.com/UnderABloodySky/bacco-backend/blob/dev/assets/imgs/recipe/recipe_35.jpg")
            ...
            val coconutron = Recipe(name = "Coconut ron", description = "Una experiencia tropical en cada trago.", imagePath = "https://github.com/UnderABloodySky/bacco-backend/blob/dev/assets/imgs/recipe/recipe_36.jpg")
            ...
            val ganciaSpritz = Recipe(name = "Gancia Spritz", description = "El toque italiano refrescante y burbujeante.", imagePath = "https://github.com/UnderABloodySky/bacco-backend/blob/dev/assets/imgs/recipe/recipe_37.jpg")
            ...
            val whiskeySour = Recipe(name = "Whiskey Sour", description = "Una mezcla perfecta de acidez y dulzura.", imagePath = "https://github.com/UnderABloodySky/bacco-backend/blob/dev/assets/imgs/recipe/recipe_38.jpg")
            ...
            val mintWhiskey = Recipe(name = "Mint Whiskey", description = "Refrescante y lleno de carácter.", imagePath = "https://github.com/UnderABloodySky/bacco-backend/blob/dev/assets/imgs/recipe/recipe_39.jpg")
            ...
            val vinoTintoSpritz = Recipe(name = "Vino Tinto Spritz", description = "Un toque espumoso y refrescante al vino tinto.", imagePath = "https://github.com/UnderABloodySky/bacco-backend/blob/dev/assets/imgs/recipe/recipe_40.jpg")
            ...
            val spicyRedWine = Recipe(name = "Spicy Red Wine", description = "Un toque picante para el clásico vino tinto.", imagePath = "https://github.com/UnderABloodySky/bacco-backend/blob/dev/assets/imgs/recipe/recipe_41.jpg")
            ...
            val ginAndMenta = Recipe(name = "Gin & Menta", description = "Un trago revitalizante y fresco.", imagePath = "https://github.com/UnderABloodySky/bacco-backend/blob/dev/assets/imgs/recipe/recipe_42.jpg")
            ...
            val gingerGinFizz = Recipe(name = "Ginger Gin Fizz", description = "Una explosión de sabores cítricos y picantes.", imagePath = "https://github.com/UnderABloodySky/bacco-backend/blob/dev/assets/imgs/recipe/recipe_43.jpg")
            ...
            val ronAndBerries = Recipe(name = "ron & Berries", description = "Dulzura y frescura en un solo trago.", imagePath = "https://github.com/UnderABloodySky/bacco-backend/blob/dev/assets/imgs/recipe/recipe_44.jpg")
            ...
            val licorDeNaranja = Recipe(name = "Licor de Naranja", description = "El dulce encanto de la naranja.", imagePath = "https://github.com/UnderABloodySky/bacco-backend/blob/dev/assets/imgs/recipe/recipe_45.jpg")
            ...
            val fernetJengibre = Recipe(name = "Fernet Ginger", description = "Un trago con un toque de picante.", imagePath = "https://github.com/UnderABloodySky/bacco-backend/blob/dev/assets/imgs/recipe/recipe_46.jpg")
            ...
            val whiskeyAndBerries = Recipe(name = "Whiskey & Berries", description = "Una mezcla de carácter y dulzura.", imagePath = "https://github.com/UnderABloodySky/bacco-backend/blob/dev/assets/imgs/recipe/recipe_47.jpg")
            ...
            val vinoSpritz = Recipe(name = "Vino Spritz", description = "El vino en su versión más refrescante.", imagePath = "https://github.com/UnderABloodySky/bacco-backend/blob/dev/assets/imgs/recipe/recipe_48.jpg")
            ...
            val cucumberGin = Recipe(name = "Cucumber Gin", description = "Ligero y refrescante, perfecto para el verano.", imagePath = "https://github.com/UnderABloodySky/bacco-backend/blob/dev/assets/imgs/recipe/recipe_49.jpg")
            ...
            val margaritaDurazno = Recipe(name = "Margarita de Durazno", description = "Una margarita con el sabor dulce del durazno fresco.", imagePath = "https://github.com/UnderABloodySky/bacco-backend/blob/dev/assets/imgs/recipe/recipe_50.jpg")
            ...
            val margaritaCereza = Recipe(name = "Margarita de Cereza", description = "Una margarita con el sabor dulce y ácido de las cerezas frescas.", imagePath = "https://github.com/UnderABloodySky/bacco-backend/blob/dev/assets/imgs/recipe/recipe_52.jpg")
            ...
            val margaritaFrutasTropicales = Recipe(name = "Margarita de Frutas Tropicales", description = "Una margarita con una mezcla de frutas tropicales para un sabor exótico y refrescante.", imagePath = "https://github.com/UnderABloodySky/bacco-backend/blob/dev/assets/imgs/recipe/recipe_53.jpg")
            ...
            val margaritaCoco = Recipe(name = "Margarita de Coco", description = "Una margarita con el sabor tropical y cremoso del coco fresco.", imagePath = "https://github.com/UnderABloodySky/bacco-backend/blob/dev/assets/imgs/recipe/recipe_54.jpg")
            ...
            val margaritaSandia = Recipe(name = "Margarita de Sandía", description = "Una margarita refrescante con el dulce sabor de la sandía fresca.", imagePath = "https://github.com/UnderABloodySky/bacco-backend/blob/dev/assets/imgs/recipe/recipe_55.jpg")
            ...
            val mojitomanzana = Recipe(name = "Mojito de Fruta de la Pasión", description = "Un mojito con el sabor exótico y refrescante de la fruta de la pasión.", imagePath = "https://github.com/UnderABloodySky/bacco-backend/blob/dev/assets/imgs/recipe/recipe_59.jpg")
            ...
            val mojitoSandia = Recipe(name = "Mojito de Sandía", description = "Un mojito con el sabor refrescante y dulce de la sandía fresca.", imagePath = "https://github.com/UnderABloodySky/bacco-backend/blob/dev/assets/imgs/recipe/recipe_60.jpg")
            ...
            val mojitoUva = Recipe(name = "Mojito de Uva", description = "Un mojito con el sabor dulce y jugoso de las uvas frescas.", imagePath = "https://github.com/UnderABloodySky/bacco-backend/blob/dev/assets/imgs/recipe/recipe_62.jpg")
